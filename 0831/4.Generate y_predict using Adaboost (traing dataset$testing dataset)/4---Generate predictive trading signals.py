...
#
# X_test['speed_ETH_Open_R(-1)'] = np.where(np.isinf(X_test['speed_ETH_Open_R(-1)']), 10000, X_test['speed_ETH_High_R(-1)'])
# X_test['speed_ETH_Open_R(-2)'] = np.where(np.isinf(X_test['speed_ETH_Open_R(-2)']), 10000, X_test['speed_ETH_High_R(-2)'])
