...
def gbc_ada_opt_test(X_train, y_train, X_test):
    ...
    base_classifier = GradientBoostingClassifier(n_estimators=250, max_depth=9, random_state=1016,verbose=3)
    # Create an AdaBoostClassifier and use the gradient lift tree as the base classifier
    adaboost = AdaBoostClassifier(estimator=base_classifier,learning_rate=0.0001, n_estimators=250, random_state=1016)
