...
pair_feature = pd.concat([BTC[['Open', 'High', 'Low', 'Close', 'Volume']],
                          ETH[['Open', 'High', 'Low', 'Close', 'Volume']]], ignore_index=True, axis=1)
...
pair_feature_ratio_shift1.columns=['BTC_Open_R(-1)', 'BTC_High_R(-1)', 'BTC_Low_R(-1)', 'BTC_Close_R(-1)', 'BTC_Volume_R(-1)',
                                   'ETH_Open_R(-1)', 'ETH_High_R(-1)', 'ETH_Low_R(-1)', 'ETH_Close_R(-1)', 'ETH_Volume_R(-1)']
# Normalization  Daily Change rate
pair_feature_ratio_shift2=normalize_series(pair_feature.shift(2)).dropna()
pair_feature_ratio_shift2.columns=['BTC_Open_R(-2)', 'BTC_High_R(-2)', 'BTC_Low_R(-2)', 'BTC_Close_R(-2)', 'BTC_Volume_R(-2)',
                                   'ETH_Open_R(-2)', 'ETH_High_R(-2)', 'ETH_Low_R(-2)', 'ETH_Close_R(-2)', 'ETH_Volume_R(-2)']
...
nor_pair_feature.columns=['BTC_Open_R', 'BTC_High_R', 'BTC_Low_R', 'BTC_Close_R', 'BTC_Volume_R',
                      'ETH_Open_R', 'ETH_High_R', 'ETH_Low_R', 'ETH_Close_R', 'ETH_Volume_R']
...
training_dataset.insert(len(training_dataset.columns), 'up_th', pair_trading_dataset['up_th'])
training_dataset.insert(len(training_dataset.columns), 'lw_th', pair_trading_dataset['lw_th'])

training_dataset.insert(len(training_dataset.columns), 'pair_trading_z(-1)', pair_trading_dataset['z_score(-1)'])
training_dataset.insert(len(training_dataset.columns), 'pair_trading_z(-2)', pair_trading_dataset['z_score(-2)'])
