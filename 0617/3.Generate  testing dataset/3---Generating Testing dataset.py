...
testing_dataset.insert(len(testing_dataset.columns), 'up_th', pair_trading_dataset['up_th'])
testing_dataset.insert(len(testing_dataset.columns), 'lw_th', pair_trading_dataset['lw_th'])

testing_dataset.insert(len(testing_dataset.columns), 'pair_trading_z(-1)', pair_trading_dataset['z_score(-1)'])
testing_dataset.insert(len(testing_dataset.columns), 'pair_trading_z(-2)', pair_trading_dataset['z_score(-2)'])
